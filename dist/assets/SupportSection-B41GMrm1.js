import{j as e}from"./ui-vendor-q7wFqjOa.js";import{r as o}from"./react-core-uW5GauGR.js";import{s as v,B as f}from"./index-CqmKntzG.js";import{d as S,T as M,D as O,a as z,c as Q,b as X,I as C}from"./badge-DxRVC9FS.js";import{T as Z}from"./textarea-KdVegif3.js";import{L as y}from"./label-CaugLUZh.js";import{S as J,a as Y,b as ee,c as ae,d as te}from"./select-DrpIO0f_.js";import{C as T,c as L}from"./card-Bt2o_KbW.js";import{E as U,S as se}from"./App-CskH4_4Y.js";import{u as V,a as u}from"./appStore-DZKr_UpI.js";import{u as ie}from"./useProducts-BqyLk0Fz.js";import{t as F}from"./notifications-Bi33bcEl.js";import{e as ne,t as A,am as re,al as le,an as ce,ao as oe,n as de,ak as me,o as ue,G as ge,y as he,z as K,X as pe,Z as xe}from"./icons-BdpAQ6Hm.js";import"./utils-CUtzRjuR.js";import"./firebase-BZSrvpf7.js";import"./NotFound-BQdtaFB_.js";import"./state-BjmFXnif.js";const be=()=>{const{user:h}=V(),[m,s]=o.useState(!1),[a,l]=o.useState([]),r=o.useCallback(async c=>{s(!0);try{const i=await S.create({user_id:h?.uid,subject:c.subject,category:c.category,email:c.email,description:c.description});return await M.sendTicketNotification({ticketId:i.id,subject:i.subject,category:i.category,email:i.email,description:i.description,timestamp:new Date(i.created_at||"").toLocaleString("id-ID")}),await U.sendNotificationEmail("admin@lumakara.com","Admin","🎫 Tiket Baru: "+i.subject,`Tiket dukungan baru telah dibuat:
